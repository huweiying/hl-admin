<template>
    <div class = 'authorization'>
      <div v-if = '!addOredit'>
        <div class = 'header'>授权管理 <router-link  class='back' to="/index">返回首页</router-link></div>
        <div class = 'main'>
            <div class = 'top'>
                <el-select v-model="enterprise.value" placeholder="企业/机构">
                    <el-option
                ...
                <el-select v-model="state.value" placeholder="全部授权对象">
                    <el-option
